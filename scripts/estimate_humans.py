...
print('Estimate HPS ...')
model = get_hmr_vimo(checkpoint='/home/yiwenzh5/onlineHMR_t/results/tram_prev+curr+future/checkpoint_best.pth.tar') # NOTE(yiwen) change inference checkpoint path here.
