...
print('Estimate HPS ...')
model = get_hmr_vimo(checkpoint='/ocean/projects/cis240055p/yzhao16/Video-OnlineHMR/results/onlineTRAM_3datasets/checkpoint_best.pth.tar') # NOTE(yiwen) change inference checkpoint path here.
